...
(defparameter *metadata-quality-gates-cli-json-results*
  '("flake-check" "cli-json-results"))
...
(defparameter *metadata-capability-matrix*
  `((:name "vitest-dsl"
    ...
    (:name "expect-matchers"
     ...
     :quality-gates ,*metadata-quality-gates-cli-json-results*
     :documentation ,*metadata-standard-documentation*)
    ...
    (:name "fixtures-and-restarts"
     ...
     :public-apis ("before-all" "after-all" "before-each" "after-each"
                   "around-each")
     :quality-gates ,*metadata-quality-gates-json-results*
     :documentation ,*metadata-standard-documentation*)
    (:name "fixtures"
     :status "implemented"
     :summary ,(concatenate 'string
